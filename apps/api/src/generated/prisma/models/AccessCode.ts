...
> = {
  where?: Prisma.AccessCodeWhereInput
  orderBy?:
    | Prisma.AccessCodeOrderByWithAggregationInput
    | Prisma.AccessCodeOrderByWithAggregationInput[]
...
export type AccessCodeWhereInput = {
  ...
  email?: Prisma.StringFilter<'AccessCode'> | string
  role?: Prisma.EnumRoleFilter<'AccessCode'> | $Enums.Role
  used?: Prisma.BoolFilter<'AccessCode'> | boolean
...
export type AccessCodeScalarWhereWithAggregatesInput = {
  AND?:
    | Prisma.AccessCodeScalarWhereWithAggregatesInput
    | Prisma.AccessCodeScalarWhereWithAggregatesInput[]
  ...
  email?: Prisma.StringWithAggregatesFilter<'AccessCode'> | string
  role?: Prisma.EnumRoleWithAggregatesFilter<'AccessCode'> | $Enums.Role
  used?: Prisma.BoolWithAggregatesFilter<'AccessCode'> | boolean
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'code' | 'email' | 'role' | 'used' | 'expiresAt' | 'createdAt',
  ExtArgs['result']['accessCode']
>
...
export interface AccessCodeFieldRefs {
  ...
  readonly email: Prisma.FieldRef<'AccessCode', 'String'>
  readonly role: Prisma.FieldRef<'AccessCode', 'Role'>
  readonly used: Prisma.FieldRef<'AccessCode', 'Boolean'>
...
> = {
  ...
  data: Prisma.XOR<
    ...
    Prisma.AccessCodeUncheckedUpdateManyInput
  >
  /**
